...
public class OrderController {
    ...
    @PostMapping("/add-order")  //WORKING
    public ResponseEntity<String> addOrder(@RequestBody Order order){
        orderService.addOrder(order);
        return new ResponseEntity<>("New order added successfully", HttpStatus.CREATED);
    }

    @PostMapping("/add-partner/{partnerId}")    //WORKING
    ...
    @GetMapping("/get-order-by-id/{orderId}")   //WORKING
    ...
    @GetMapping("/get-partner-by-id/{partnerId}")   //WORKING
    ...
    @GetMapping("/get-all-orders")  //WORKING
    ...
    @GetMapping("/get-last-delivery-time/{partnerId}")//WORKING
    ...
    @DeleteMapping("/delete-partner-by-id/{partnerId}") //WORKING
    ...
    @DeleteMapping("/delete-order-by-id/{orderId}") //WORKING
